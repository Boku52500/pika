  ...
  return (
    <Container className="flex flex-col items-center gap-5 py-24 text-center sm:py-32">
      ...
      <div className="flex flex-col gap-2">
        <h1 className="text-h2 text-text">კატეგორია ვერ მოიძებნა</h1>
        <p className="text-body mx-auto max-w-md text-text-muted">
          სამწუხაროდ, ეს კატეგორია აღარ არის ხელმისაწვდომი ან მისამართი არასწორია. გთხოვთ, გადაამოწმოთ ბმული ან
