 ...
 */
export function CheckoutStickyMobileBar({ total, submitting = false }: { total: number; submitting?: boolean }) {
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-surface/97 px-4 py-3 shadow-[0_-4px_16px_rgba(13,15,21,0.08)] backdrop-blur lg:hidden">
      <div className="flex items-center gap-3">
        ...
        <Button type="submit" size="lg" className="w-auto min-w-[10rem] flex-1" disabled={submitting}>
