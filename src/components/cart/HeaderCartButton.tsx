...
/**
 * Header cart trigger — opens the mini-cart drawer instead of navigating, and
 * shows a live, non-layout-shifting count badge (absolutely positioned, so
 * the icon's box size never changes whether the badge is shown or not).
 */
